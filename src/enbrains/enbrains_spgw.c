...
static int enbrains_spgw_connected = 0;

static void * enbrains_spgw_intertask_interface (void *args_p)
{
  int                                     rc = 0;
  int                                     nb_events = 0;
...
int enbrains_spgw_init (void)
{
  ...
  if (itti_create_task (TASK_ENBRAINS, &enbrains_spgw_intertask_interface, NULL) < 0) {
