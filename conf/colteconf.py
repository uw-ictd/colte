...
if (colte_data["epc"] == True):
    ...
    os.system('systemctl stop open5gs-sgwcd')
    os.system('systemctl disable open5gs-sgwcd')
    os.system('systemctl stop open5gs-sgwud')
    os.system('systemctl disable open5gs-sgwud')
    os.system('systemctl stop open5gs-pcrfd')
    os.system('systemctl disable open5gs-pcrfd')
    os.system('systemctl stop open5gs-smfd')
    os.system('systemctl disable open5gs-smfd')
    os.system('systemctl stop open5gs-upfd')
    os.system('systemctl disable open5gs-upfd')
